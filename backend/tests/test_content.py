...
from services.content.linkedin import _validate_post
...
@pytest.mark.asyncio
async def test_generate_post_mocked(mock_anthropic):
    """Post generation with mocked Claude should return structured output."""
    mock_anthropic.messages.create.return_value.__class__.__name__ = "Message"
    # Override response for post generation
